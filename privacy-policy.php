...
<section  style="margin: 100px 0">
	<div class="container">
      ...
      <div class="">This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from middle-stone.myshopify.com (the “Site”).
        <br>
        <br> <strong>Personal information we collect</strong> 
        ...
        <br>- [[INSERT DESCRIPTIONS OF OTHER TYPES OF TRACKING TECHNOLOGIES USED]]
        <br>
        <br>Additionally when you make a purchase or attempt to make a purchase through the Site, we collect certain information from you, including your name, billing address, shipping address, payment information (including credit card numbers [[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]]), email address, and phone number. We refer to this information as “Order Information”.
        <br>
        <br>[[INSERT ANY OTHER INFORMATION YOU COLLECT: OFFLINE DATA, PURCHASED MARKETING DATA/LISTS]]
        <br>
        <br>When we talk about “Personal Information” in this Privacy Policy, we are talking both about Device Information and Order Information.
        <br>
        <br> <strong>How do we use your personal information?</strong> 
        ...
        <br>- [[INSERT OTHER USES OF ORDER INFORMATION]]
        <br>
        ...
        <br>
        <br>[[INSERT OTHER USES OF DEVICE INFORMATION, INCLUDING: ADVERTISING/RETARGETING]]
        <br>
        <br> <strong>Sharing you personal Information</strong> 
        ...
        <br>- [[INCLUDE OPT-OUT LINKS FROM WHICHEVER SERVICES BEING USED]]
        <br>
        ...
        <br>
        <br> <strong>Your rights</strong> 
        <br>If you are a European resident, you have the right to access personal information we hold about you and to ask that your personal information be corrected, updated, or deleted. If you would like to exercise this right, please contact us through the contact information below.
        <br>
        <br>Additionally, if you are a European resident we note that we are processing your information in order to fulfill contracts we might have with you (for example if you make an order through the Site), or otherwise to pursue our legitimate business interests listed above. Additionally, please note that your information will be transferred outside of Europe, including to Canada and the United States.
        <br>
        ...
        <br>The Site is not intended for individuals under the age of [[INSERT AGE]] .
        <br>
        <br> <strong>Contact us</strong> 
        <br>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at AlulayCerdaCordero@teleworm.com   or by mail using the details provided below:
        <br>
        <br>Middle Stone
        <br>[Re: Privacy Compliance Officer]
        <br>C/ Cuesta del Álamo, 65
29570 Cártama ,(Spain)
      </div>
